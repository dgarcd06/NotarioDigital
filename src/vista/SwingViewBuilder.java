...
/**
 * Esta clase, junto con SwingController, ha sufrido ciertas modificaciones para editar
 * la apariencia visual del visor de PDFs.
...
public class SwingViewBuilder implements ViewBuilder {
    ...
    protected org.icepdf.ri.common.SwingController viewerController;
     ...
     */
    public SwingViewBuilder(org.icepdf.ri.common.SwingController c) {
     ...
     */
    public SwingViewBuilder(org.icepdf.ri.common.SwingController c, ViewerPropertiesManager properties) {
     ...
     */
    public SwingViewBuilder(org.icepdf.ri.common.SwingController c, int documentViewType,
     ...
     */
    public SwingViewBuilder(org.icepdf.ri.common.SwingController c, Font bf, boolean bt, int ts,
     ...
     * Este método ha sido modificado para eliminar la Toolbar en la aplicacion
     *
...
//        addToMenu(fileMenu, buildFontInformationMenuItem());
    ...
    protected AnnotationColorToggleButton makeAnnotationToggleButton(String title, String toolTip,
        ...
        return new IconAnnotationColorToggleButton(viewerController, messageBundle, title, toolTip,
                colorPreferenceKey, imageName, "3", font, alpha);
    }
